...
% combine 2 algs into 1
% clean up alg section
% move combined alg to simulation section
% add explanation for alg in sim section
% tweak experiments section to reflect graph
% tweak conclusion to reflect graph
% write abstract
